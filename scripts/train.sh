...
#
# Defaults match configs/train.so101_pickplace.yaml. Override via env vars, e.g.:
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/train/smolvla_so101}"
...
echo "[train] next: python -m smolvla_edge.eval --policy-path ${OUTPUT_DIR}/checkpoints/last"
